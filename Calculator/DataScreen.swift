...
struct DataScreen: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UITextView {
        ...
        myTextArea.font = isDecodable ? UIFont(name: "Courier", size: DataScreen.fontSize) : UIFont.boldSystemFont(ofSize: DataScreen.fontSize)
    ...
    func updateUIView(_ uiView: UITextView, context: Context) {
        ...
        uiView.font = isDecodable ? UIFont(name: "Courier", size: DataScreen.fontSize) : UIFont.boldSystemFont(ofSize: DataScreen.fontSize + 1.0)
